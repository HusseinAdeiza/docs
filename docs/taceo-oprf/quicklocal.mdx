...
2. Deploy the `OprfKeyRegistry` contract on `anvil`
...
Now you can run the client binary again, but this time point it to your local OPRF nodes with the following command:
